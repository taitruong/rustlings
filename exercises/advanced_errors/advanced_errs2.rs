...
impl Display for ParseClimateError {
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        ...
        match self {
            ...
            ParseFloat(e) => write!(f, "error parsing temperature: invalid float literal"),
            ParseIntError => write!(f, "error parsing year: invalid digit found in string"),
        }
    }
}
...
impl FromStr for Climate {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        let (city, year, temp) = match &v[..] {
            ...
            [_, _] => return Err(ParseClimateError::BadLen),
            [city, year, temp] => {
                if city.to_string().len() == 0 {
